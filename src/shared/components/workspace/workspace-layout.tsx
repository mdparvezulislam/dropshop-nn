...
import type { Breadcrumb } from "@/shared/components/workspace/nav-config";
import type { TopbarUserMenuItem } from "@/shared/components/workspace/topbar";
import {
  buildCommandsForWorkspace,
  type WorkspaceShellConfig,
} from "@/shared/components/workspace/workspace-registry";
