...
>[] = [
  ...
  },
  {
    ...
    emailBody: "A new login was detected on your DropshopNN account.",
  ...
  },
  {
    ...
    category: "account",
    channels: ["in_app", "email"],
    subject: "Welcome to DropshopNN",
    emailBody: "Hi {{customerName}}, welcome to DropshopNN.",
    inAppTitle: "Welcome to DropshopNN",
