...
export function DescriptionSection({ value, onChange, onMagicParse }: DescriptionSectionProps): React.ReactElement {
  return (
      ...
      <div className="space-y-3">
        <div className="flex flex-wrap items-center justify-between gap-2 rounded-lg border border-amber-500/20 bg-amber-500/5 p-3 dark:bg-amber-950/20">
          <div className="text-xs text-muted-foreground">
            <span className="font-semibold text-amber-500">Pro Tip:</span> Paste raw HTML or supplier product text here, then click <strong className="text-foreground">Magic Parse</strong> to auto-extract Title, Specifications, SEO Meta, and Tags!
          </div>
          {onMagicParse ? (
            <Button
              type="button"
