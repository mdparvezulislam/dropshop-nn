...
const templateSpecFieldSchema = new Schema({
  ...
  type: { type: String, enum: ["text", "number", "boolean", "select", "multiselect", "color"], default: "text" },
...
const templatePricingProfileSchema = new Schema({
  retailMultiplier: { type: Number, default: 1.40 },
  wholesaleMultiplier: { type: Number, default: 1.30 },
