  ...
  const QUICK_LINKS = [
    {
      ...
      label: "ব্যবহারকারী ডিরেক্টরি",
      labelEn: "User Directory",
      icon: Users,
    },
    {
      href: "/dashboard/identity/applications",
      label: "অ্যাপ্লিকেশন রিভিউ",
      labelEn: "Application Review",
      icon: Building2,
    },
    {
    ...
    },
    {
      ...
      label: "পারমিশন ম্যাট্রিক্স",
      labelEn: "Permission Matrix",
      icon: ShieldCheck,
    },
    {
      href: "/dashboard/identity/staff",
    ...
    },
    {
      ...
      label: "সেশন ম্যানেজমেন্ট",
      labelEn: "Session Management",
      icon: Monitor,
    },
    {
      href: "/dashboard/identity/activity",
      label: "অ্যাক্টিভিটি লগ",
      labelEn: "Activity Log",
      icon: AlertTriangle,
    },
    {
      href: "/dashboard/identity/import",
      label: "ইম্পোর্ট/এক্সপোর্ট",
        ...
        <Card className="border-border/50 bg-card lg:col-span-2">
          <CardContent className="p-4">
            <h3 className="text-sm font-semibold mb-3">
              সাম্প্রতিক রেজিস্ট্রেশন / Recent Registrations
            </h3>
            {loading ? (
