      ...
      <div className="grid gap-5 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-5">
          <Card className="border-border/50 bg-card">
            <CardHeader>
              <CardTitle className="text-sm">প্রোফাইল তথ্য</CardTitle>
            </CardHeader>
            <CardContent className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <p className="text-xs text-muted-foreground">রেজিস্ট্রেশন</p>
                <p className="text-sm flex items-center gap-1">
        ...
        <div className="space-y-5">
          <Card className="border-border/50 bg-card">
            <CardHeader>
              <CardTitle className="text-sm">অ্যাকাউন্ট অ্যাকশন</CardTitle>
            </CardHeader>
          ...
          <Card className="border-border/50 bg-card">
            <CardHeader>
              <CardTitle className="text-sm">রোল ও পারমিশন</CardTitle>
            </CardHeader>
            <CardContent className="space-y-2">
