      ...
      <div className="grid gap-3 grid-cols-2 sm:grid-cols-4">
        <Card className="border-border/50 bg-card/50">
          <CardContent className="p-3">
            ...
            <p className="text-xl font-bold">{data?.pendingApprovals ?? 0}</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 bg-card/50">
          <CardContent className="p-3">
            ...
            <p className="text-xl font-bold text-emerald-400">{data?.activeUsers ?? 0}</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 bg-card/50">
          <CardContent className="p-3">
            ...
            <p className="text-xl font-bold text-rose-400">{data?.suspendedUsers ?? 0}</p>
          </CardContent>
        </Card>
        <Card className="border-border/50 bg-card/50">
          <CardContent className="p-3">
            ...
            <p className="text-xl font-bold text-sky-400">{data?.activeSessions ?? 0}</p>
          </CardContent>
        </Card>
      </div>
