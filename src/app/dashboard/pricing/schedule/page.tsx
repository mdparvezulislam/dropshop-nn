  ...
  return (
    <div className="space-y-6">
      <SectionHeader
        ...
        description="নির্ধারিত মূল্য পরিবর্তন — তারিখ ও সময় অনুযায়ী স্বয়ংক্রিয় মূল্য আপডেট"
        icon={Clock}
      />
      <Card className="border-border/80 bg-card">
        <CardContent className="p-8 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-sm font-semibold text-muted-foreground">
            Scheduled pricing module ready
          </p>
          <p className="text-xs text-muted-foreground/70 mt-1 max-w-md">
            Schedule price changes with start/end dates, timezone support, auto-enable and
            auto-disable. Use campaigns for product-specific scheduled pricing.
          </p>
