  ...
  return (
    <div className="space-y-6">
      <SectionHeader
        ...
        description="লাইভ মূল্য নির্ধারণ সিমুলেটর — খরচ, মার্কআপ ও লাভ তাৎক্ষণিক গণনা"
        icon={Calculator}
      />
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">
              Input Parameters{" "}
              <span className="text-xs font-normal text-muted-foreground">প্যারামিটার</span>
            </CardTitle>
          </CardHeader>
            ...
            <>
              <Card className="border-success/30 bg-success/5">
                <CardContent className="p-5">
                  ...
                  <div className="text-2xl font-bold">
                    {formatCentsToCurrency(form.costPrice * 100, "BDT")}
                  </div>
                  <div className="mt-3 grid grid-cols-2 gap-3">
                    <div>
                      <div className="text-xs text-muted-foreground">লাভ</div>
                      <div className="text-lg font-semibold text-success">
                        {formatCentsToCurrency(result.profit * 100, "BDT")}
                      </div>
                    </div>
                    <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <Card
                    key={tier.role}
                    className={`${form.role === tier.role.toLowerCase() ? "border-primary/50 ring-1 ring-primary/20" : ""}`}
                  >
                    <CardContent className="p-4">
                      ...
                      <div className="text-xl font-bold mt-0.5">
                        {formatCentsToCurrency(tier.value * 100, "BDT")}
                      </div>
                      {result && (
                  ...
                  <CardContent className="p-4 flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-lg font-bold text-warning">
                        {formatCentsToCurrency(result.campaignPrice * 100, "BDT")}
                      </div>
                    </div>
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-bold">
                      {formatCentsToCurrency(result.roundedPrice * 100, "BDT")}
                    </span>
                  </div>
                  <div className="flex items-center justify-between text-sm mt-1">
                    <span className="text-muted-foreground">Net Profit (নিট মুনাফা)</span>
                    <span className="font-bold text-success">
                      {formatCentsToCurrency(result.netProfit * 100, "BDT")}
                    </span>
                  </div>
                </CardContent>
              </Card>
            ...
            <Card>
              <CardContent className="p-8 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-sm font-semibold text-muted-foreground">
                  Enter parameters & calculate
                </p>
                <p className="text-xs text-muted-foreground/70 mt-1">
                  See live pricing for all channels
                </p>
              </CardContent>
            </Card>
          )}
