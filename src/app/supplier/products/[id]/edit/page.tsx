...
const EMPTY_VARIANT: VariantRow = { id: "", sku: "", label: "", price: "", stock: "", weight: "" };

export default function SupplierEditProductPage(): React.ReactElement {
  ...
  const [variants, setVariants] = React.useState<VariantRow[]>([{ ...EMPTY_VARIANT }]);
  ...
  return (
    <div className="space-y-6 animate-[fade-in_0.2s_ease-out]">
      <div className="flex items-center gap-3">
        ...
        <PageHeader title="Edit Product" description={`Editing: ${form.name}`} />
      </div>
