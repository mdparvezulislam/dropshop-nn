...
const COLLECTIONS = [
  {
    ...
    description: "বাংলাদেশে বর্তমানে সবচেয়ে বেশি সেল হওয়া ফাস্ট চার্জার, TWS এয়ারবাডস এবং স্মার্ট ওয়াচ সমূহ।",
    icon: TrendingUp,
    badge: "হট চয়েস",
  ...
  },
  {
    ...
    description: "প্রিমিয়াম বিল্ড কোয়ালিটি এবং সাউন্ড পারফরম্যান্স সম্বলিত বাছাইকৃত ইলেকট্রনিক্স গ্যাজেট।",
    icon: Star,
    badge: "টপ রেটেড",
  ...
  },
  {
    ...
    description: "ইলেকট্রনিক্স শপ ওনার এবং রিসেলারদের জন্য বিশেষ পাইকারি ক্যাটালগ ও বাল্ক ডিসকাউন্ট।",
    icon: Award,
    badge: "পাইকারি অফার",
