...
export default function CollectionLoading(): ReactElement {
  return (
    <div className="min-h-screen bg-[hsl(0_0%_98%)] py-8">
      ...
      >
        ...
        <div className="space-y-3 rounded-3xl border border-slate-200 bg-white p-6 sm:p-8">
          <div className="h-8 w-72 max-w-full animate-pulse rounded-xl bg-slate-200" />
