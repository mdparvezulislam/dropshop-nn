...
export const metadata = {
  ...
  description: "Pathao Express and Steadfast Courier delivery timelines, shipping rates, and Cash on Delivery guidelines across BD.",
};
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-white font-heading">Shipping & Courier Policy</h1>
        ...
        <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-8 backdrop-blur-md prose prose-invert max-w-none text-xs leading-relaxed text-slate-300">
          {content?.bodyHtml ? (
            ...
            <div>
              ...
              <p>Orders within Dhaka City are fulfilled via Pathao Express Courier with standard delivery within 24 hours.</p>
              <h2>Nationwide Delivery</h2>
              <p>District and Upazila deliveries are handled via Steadfast Courier with full Cash-on-Delivery (COD) support within 48 to 72 hours.</p>
            </div>
          )}
        </div>
      </div>
