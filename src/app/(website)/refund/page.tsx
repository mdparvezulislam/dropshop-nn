    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-white font-heading">Refund & Return Policy</h1>
        ...
        <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-8 backdrop-blur-md prose prose-invert max-w-none text-xs leading-relaxed text-slate-300">
          {content?.bodyHtml ? (
            ...
            <div>
              ...
              <p>If a product delivered to your customer is physically damaged or non-functional upon unboxing, DropshopNN provides a full replacement within 7 days of delivery.</p>
              <h2>Wallet Refund Process</h2>
              <p>Refunds for cancelled or returned orders are credited directly to your reseller wallet or original bKash/Nagad payment method within 24 to 48 hours.</p>
            </div>
          )}
        </div>
      </div>
