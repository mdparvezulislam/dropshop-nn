...
export function FooterCTASection(): React.ReactElement {
  return (
    <section className="w-full py-16 lg:py-24 bg-gradient-to-r from-accent via-white to-accent border-t border-border/50" aria-label="Support & Registration CTA">
        ...
        >
          <div className="lg:col-span-7 space-y-5">
            ...
            <p className="text-base text-muted-foreground leading-relaxed max-w-xl">
              Join 5,000+ active resellers, retail store owners, and suppliers already growing with DropshopNN enterprise automation across 64 districts.
            </p>

            <div className="flex flex-wrap items-center gap-3 pt-2">
              <Link href="/become-reseller">
                <Button size="lg" className="h-12 px-6 text-sm font-bold shadow-md hover:shadow-lg transition-all active:scale-[0.98]">
                  Start as Reseller
                  <ArrowRight className="h-4 w-4 ml-2" />
                </Button>
              </Link>
              <Link href="/become-wholesale-partner">
                <Button size="lg" variant="outline" className="h-12 px-6 text-sm font-bold border-primary/30 text-primary hover:bg-accent">
                  Wholesale Account
                </Button>
              </Link>
            </div>
          ...
          <div className="lg:col-span-5 rounded-3xl bg-card border border-border/80 p-6 sm:p-8 shadow-xl space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <a href="tel:+8801700000000" className="flex items-center gap-3 p-3 rounded-xl bg-muted/40 hover:bg-accent border border-border/60 transition-all group">
              ...
              <a href="https://wa.me/8801700000000" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-xl bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 transition-all text-emerald-900 group">
              ...
              <a href="mailto:hello@dropshopnn.com" className="flex items-center gap-3 p-3 rounded-xl bg-muted/40 hover:bg-accent border border-border/60 transition-all group">
                <div className="p-2 rounded-lg bg-primary/10 text-primary group-hover:scale-110 transition-transform">
