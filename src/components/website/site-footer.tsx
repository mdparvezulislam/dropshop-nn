...
import { CreditCard, Package, Shield, Phone, Mail, MapPin } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link href="/" className="flex items-center gap-2.5 group w-fit">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-500 text-white font-black text-xl shadow-md">
                D
              </div>
            ...
            <div className="flex items-center gap-2.5 pt-2">
              {SOCIAL_LINKS.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/10 text-slate-300 hover:text-amber-400 hover:bg-white/20 transition-all border border-white/10"
                >
